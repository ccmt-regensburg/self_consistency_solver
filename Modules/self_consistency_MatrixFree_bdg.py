...
def self_consistent_potentials(nDim, n, T, U, Nm, pairing, onsite, mu, hopping, dtype=np.float64):#, mixing=1.0):
        """
...
#       mixing_after=1.0
        ...
        for j in range(iterstart,niter):
                ...
                if diag:
                        ...
                        delta_i, n_i, mu, dos, pairingdos=self_consistent_potentials(2*ndim, n, T, U, Nm, pairing, onsite, mu_old, hopping, dtype=dtype)
                        e=False
